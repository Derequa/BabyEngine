...
${OBJECTDIR}/DebugObject.o: DebugObject.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DebugObject.o DebugObject.cpp
...
${OBJECTDIR}/EngineComponent.o: EngineComponent.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EngineComponent.o EngineComponent.cpp

${OBJECTDIR}/EngineObject.o: EngineObject.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EngineObject.o EngineObject.cpp
...
${OBJECTDIR}/EventListener.o: EventListener.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EventListener.o EventListener.cpp
